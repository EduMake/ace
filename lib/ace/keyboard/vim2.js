...
define(function(require, exports, module) {
  ...
  CodeMirror.prototype.virtualSelectionMode = function() {
  ...
  CodeMirror.prototype.addOverlay = function(o) {
  ...
  CodeMirror.prototype.removeOverlay = function(o) {
    if (this.$searchHighlight && this.$searchHighlight.session) {
...
(function() {
  ...
  function multiSelectHandleKey(cm, key, origin) {
    ...
    if (key == '<Esc>' && !vim.insertMode && !vim.visualMode && cm.ace.inMultiSelectMode) {
      ...
      isHandled = CodeMirror.Vim.handleKey(cm, key, origin);
    } else {
  ...
  var getVim = CodeMirror.Vim.maybeInitVimState_;
  exports.handler = {
    cm: null,
